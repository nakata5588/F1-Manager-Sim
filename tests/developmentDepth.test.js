...
function database() {
  return {
    ...
    driverRatings: [
      { driver_id: "YOUNG", current_ability: 60, potential_ability: 88, pace: 61, qualifying: 60, racecraft: 58, consistency: 57, technical_feedback: 55, adaptability: 58, leadership: 38, team_player: 62 },
      { driver_id: "MENTOR", current_ability: 79, potential_ability: 82, pace: 78, qualifying: 77, racecraft: 84, consistency: 83, technical_feedback: 88, adaptability: 76, leadership: 90, team_player: 86 },
      { driver_id: "TEST", current_ability: 66, potential_ability: 76, pace: 64, qualifying: 63, racecraft: 70, consistency: 72, technical_feedback: 82, adaptability: 80, leadership: 60, team_player: 78 },
    ],
    contracts: [
      { driver_id: "YOUNG", team_id: "T1", role: "main_driver", contract_start: 1980, contract_until: 1983 },
      { driver_id: "MENTOR", team_id: "T1", role: "second_driver", contract_start: 1980, contract_until: 1983 },
      { driver_id: "TEST", team_id: "T1", role: "test_driver", contract_start: 1980, contract_until: 1983 },
    ],
    staff: [
    ...
    staffRatings: [
      { staff_id: "COACH", current_ability: 75, potential_ability: 80, driver_development: 90, motivation: 85, communication: 86, leadership: 84 },
      { staff_id: "JUNIOR", current_ability: 58, potential_ability: 82, technical: 60, data_analysis: 57, innovation: 59, communication: 62, leadership: 45 },
      { staff_id: "SENIOR", current_ability: 82, potential_ability: 85, technical: 88, data_analysis: 84, innovation: 83, communication: 80, leadership: 86 },
    ],
    staffContracts: [
      { staff_id: "COACH", team_id: "T1", role: "team_manager", contract_start: 1980, contract_until: 1984 },
      { staff_id: "JUNIOR", team_id: "T1", role: "design_engineer", contract_start: 1980, contract_until: 1984 },
      { staff_id: "SENIOR", team_id: "T1", role: "technical_director", contract_start: 1980, contract_until: 1984 },
    ],
    teamFinancials: [{ team_id: "T1", cash_balance: 2_000_000 }],
    carStats: [{ team_id: "T1", chassis_spec: 60, aero_spec: 60, gearbox_spec: 60 }],
    facilities: [{ team_id: "T1", wind_tunnel_level: 6, manufacturing_level: 6 }],
    sponsorContracts: [],
    engines: [],
    teamEngines: [],
    tracks: [],
